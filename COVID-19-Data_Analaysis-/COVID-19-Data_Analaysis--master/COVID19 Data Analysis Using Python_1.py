...
path = r"C:\Users\Anonymous\Desktop\Puruboi\Towards_Data_science\COVID19 Data Analysis Using Python\Try same with these datasets\covid19_deaths_dataset.csv"
df = covid_death_dataset_csv = pd.read_csv(path)
df.head(10)
...
path_2 = r"C:\Users\Anonymous\Desktop\Puruboi\Towards_Data_science\COVID19 Data Analysis Using Python\Try same with these datasets\worldwide_happiness_report_1.csv"
...
data.to_excel("./Correlation_check_1.xlsx")  # loading to Excel

# visualising the results using seaborn module

#Plotting GDP per capita vs Max_infection_rate 
